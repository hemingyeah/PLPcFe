...
/* scss */
import './FormCalculationFormula.scss'
...
@Component({ name: 'form-calculation-formula' })
export default class FormCalculationFormula extends Vue {
  ...
  get calculationFormulaFormatted() {
    return (
      this.calculationFormula
        .map((item: CalculationFormulaItem) => item.isOperator ? item.value : 0)
        .join('')
    )
  }
  ...
  */
  private confirm(): void {
    let result = validate(this.calculationFormulaFormatted)
