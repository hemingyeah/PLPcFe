...
const PRODUCT_FRAME_NAV = 'guide-product-framenav';
const PRODUCT_TEAM_LIST_VIEW = 'guide-product-teamListView';
const PRODUCT_PRODUCT_SET = 'guide-product-productSet'
...
const PRODUCT_PRODUCT_EDIT = 'guide-product-edit'
