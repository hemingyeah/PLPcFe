...
import { fields, selectIds, advancedList, allExport, Inquire } from './ProductFieldModel';
  ...
  methods: {
    ...
    searchList() {
      ...
      return TaskApi.search(searchParams)
        ...
        .catch((err) => {
          console.warn('Caused: ProductList search Function err', err);
        })
        .finally(() => {
          this.loading = false;
        });
    ...
    openTaskTab(taskId, taskNo) {
      ...
      this.$platform.openTab({
        ...
        title: `工单${taskNo}`,
        close: true,
        url: `/productV2/view/${taskId}?noHistory=1`,
        fromId,
      });
    },
    /**
