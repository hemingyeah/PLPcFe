  ...
  <div id="normal-setting-components-box"
    ...
    <div class="flex-x box-12 bg-w mar-btm-10">
      ...
      <el-button type="primary"
                 @click="openTab">配置自定义字段</el-button>
    </div>
    <div class="flex-x box-12 bg-w mar-btm-10">
      <div class="flex-1">
      ...
      <div class="mar-top-52">
        <el-switch v-model="productSearchOnMobile"
                   @change="saveFunc($event, 'productSearchOnMobile')"></el-switch>
    ...
    <div class="flex-x box-12 bg-w">
      ...
      <el-button type="primary"
                 @click="openQrcodeList">前往</el-button>
    </div>

    <div class="flex-x box-12 bg-w mar-btm-10">
      <el-button type="primary"
                 @click="goSuperqrcodeSet">修改产品二维码设置</el-button>
    </div>
      ...
      <el-form :model="form"
        ...
        <el-form-item label="名称"
          ...
          <el-input type="text"
                    ...
                    placeholder="规则的名称（最多10个字）"></el-input>
        </el-form-item>
        ...
        <el-form-item label="选择应用条件，当"
                      v-show="form.ruleType == 3"
                      required>
          <el-col :span="8">
            <el-form-item>
              <el-select style="width: calc(100% - 65px)"
                         @change="applyChange"
                         v-model="form.apply"
                         size="mini"
                         :popper-append-to-body="false"
          ...
          <el-col :span="6">
            <el-form-item prop="option">
              <el-select style="width: calc(100% - 25px)"
            ...
            <el-form-item prop="selectUser"
              ...
              <el-select size="mini"
                ...
                <el-option v-for="item in userList"
                           ...
                           :value="item.userId || item.id"></el-option>
              </el-select>
            </el-form-item>
        ...
        <el-form-item label="客服优先顺序"
                      required>
          <el-select v-model="form.distributePriority"
                     size="mini"
                     :popper-append-to-body="false"
                     popper-class="select-popper">
            <el-option label="按顺序平均分配"
                       :value="1"></el-option>
          </el-select>
        </el-form-item>
      </el-form>
