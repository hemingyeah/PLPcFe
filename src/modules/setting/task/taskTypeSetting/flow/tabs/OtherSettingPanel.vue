<template>
    <div class="other-setting-panel">
        ...
        <!-- 系统模板设置字段弹窗 -->
        <system-template-dialog :visiable.sync="isShowSystemModal" :type="templateType" :taskTypeId="taskFlowData.taskTypeId"/>
        <!-- 导入模板设置弹窗 -->
        <template-upload-dialog :visiable.sync="isShowTemplateUploadModal" :type="templateType" :taskTypeId="taskFlowData.taskTypeId">
