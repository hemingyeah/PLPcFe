      ...
      <template slot="customer" slot-scope="{ field }">
        ...
        <form-item :label="field.displayName">
          <div class="input-and-btn">
            ...
            <el-button @click="dialogOpen('customer')" v-if="!isCreateCustomer && allowCreateCustomer">新建</el-button>
          </div>
        ...
        <form-item v-if="customerOption.linkman" label="联系人">
          <div class="input-and-btn">
            ...
            <el-button @click="dialogOpen('contact')" v-if="!isCreateCustomer && allowCreateCustomer">新建</el-button>
          </div>
        </form-item>
        <!-- end 联系人 -->
        ...
        <form-item v-if="customerOption.address" label="地址">
          <div class="input-and-btn">
            ...
            <el-button @click="dialogOpen('address')" v-if="!isCreateCustomer && allowCreateCustomer">新建</el-button>
          </div>
        </form-item>
        <!-- end 地址 -->
        ...
        <form-item v-if="customerOption.product" label="产品" :validation="validation.product">
          ...
          <div class="input-and-btn">
            ...
            <el-button @click="dialogOpen('product')" v-if="allowCreateProduct">新建</el-button>
          </div>
