...
export const settingMap = {
  ...
  cycleCompleteTaskProductCount: { label: '周期内完成工单的按照产品类型显示数量和比例', value: false, belong: 'rightPieChart' },
  cycleEvaluateTaskCustomerSatisfied: { label: '周期内已评价工单的客户满意度比例', value: true, belong: 'rightPieChart' },
}
