<template>
  ...
  <div class="department-container" v-loading.fullscreen.lock="loading">
    ...
    <div class="department-main">
      ...
      <el-tabs type="card" v-model="activeName" @tab-click="handleClick">
        ...
        <el-tab-pane label="角色" name="role">
          <div v-if="roles.length > 0" class="department-child-list">
            <div class="department-child-item" v-for="role in roles" :key="role.id" @click="chooseRole(role)">
              <span>
                {{ role.name }} &nbsp;&nbsp;
      ...
      <div v-if="activeName === 'tag'" class="department-main-right">
        ...
        <div class="department-child-block">
          ...
          <div class="department-user-table" v-if="subDepartments.length > 0">
            ...
            >
              ...
              <el-table-column prop="displayName" label="部门名称"/>
              <el-table-column prop="loginName" label="部门主管" />
              <el-table-column prop="cellPhone" label="联系电话" />
              <el-table-column prop="cellPhone" label="部门位置" />
              <el-table-column prop="cellPhone" label="负责区域" />
            ...
            <div class="table-footer">
              <div class="list-info">
                共<span class="level-padding">{{subDepartments.length}}</span>记录
              </div>
            </div>
        ...
        <div class="department-user-block">
          ...
          <div class="dept-search-group">
            <el-input v-model="keyword" placeholder="请输入成员名称搜索" style="width:200px;">
              <i slot="prefix" class="el-input__icon el-icon-search"></i>
            </el-input>
            <base-button type="primary" @event="search();">搜索</base-button>
            <base-button type="primary">导出动态</base-button>
            <base-button type="primary">添加成员</base-button>
            <base-button type="primary">移除成员</base-button>
            ...
            >
              ...
              <el-table-column label="操作" width="150px"> 
                <template slot-scope="scope">
                  ...
                  <el-button type="text" style="color:#e6a23c" >停用</el-button>
                  <el-button type="text" style="color:#FB602C" >删除</el-button>
      ...
      <!-- start 角色列表 -->
      <div v-if="activeName === 'role'" class="department-main-right">
        ...
        <div class="department-user-block">
          ...
          <div class="department-user-table" v-if="rolePage.list.length > 0">
            ...
            >
              ...
              <el-table-column prop="loginName" label="账号" />
              <el-table-column prop="loginName" label="部门" />
              <el-table-column prop="cellPhone" label="联系电话" />
              <el-table-column prop="enabled" label="状态">
                <template slot-scope="scope">
                  {{scope.row.enabled == 1 ? '启用' : '禁用'}}
...
export default {
  ...
  methods: {
    async resetPwd(){
      if(await this.$platform.confirm('确定将该成员的密码重置吗？重置后的密码为123456')){
        // this.userDelete();
      }
    },
    search(){
    ...
    async chooseRole(role){
      ...
      // console.log(res);
      this.rolePage.list = [];
      return getRoleUser(params).then(rolePage => {
    ...
    addDepartment() {
      ...
      platform.openTab({
        id: 'createTag',
        title: '新建部门',
        url: `/security/tag/createTagV2?${qs.stringify(parent)}`,
        reload: true,
      });
    ...
    openDepartmentEditPanel() {
      ...
      platform.openTab({
        id: 'editTag',
        title: '编辑部门',
        url: `/security/tag/editTagV2/${this.selectedDept.id}`,
        reload: true,
      });
    },
    /** select person */ 
