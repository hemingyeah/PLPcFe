  ...
  <el-dialog title="退回" :visible.sync="visible" width="600px" top="10vh">
    <el-form :model="form" :rules="rules" ref="form" label-width="100px" class="common-form">
      ...
      <el-form-item label="备件编号：">
        <el-input type="text" :value="part.serialNumber" readonly class="srp-readonly"></el-input>
      </el-form-item>
      <el-form-item label="备件类别：">
        <el-input type="text" :value="part.type" readonly class="srp-readonly"></el-input>
      </el-form-item>
      <el-form-item label="备件规格：">
        <el-input type="text" :value="part.standard" readonly class="srp-readonly"></el-input>
      </el-form-item>
