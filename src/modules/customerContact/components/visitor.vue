<template>
  ...
  >
    ...
    <base-modal :show.sync="visible_form" title="请维护客户信息" class="form-address-modal">
      <div class="modal-box">
        <diy-form :config="{fields:this.productFieldsSaveCustomer}" ref="diyForm"></diy-form>
        <div class="flex-x" slot="footer">
          <base-button type="primary" @event="saveCustomer">确定</base-button>
        </div>
      </div>
    </base-modal>
  </div>
