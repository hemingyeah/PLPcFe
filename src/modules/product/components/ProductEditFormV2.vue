          ...
          >
            ...
            >
              ...
              <p>
                ...
                >
                <span
                ><label>产品类型：</label><span>{{ option.type }}</span></span
                >
              </p>
            </div>
          </base-select>
        ...
        .then((res) => {
          ...
          if (res.data.list) {
            res.data.list = res.data.list.map((address) =>
              Object.freeze({
                label: `${address.province} ${address.city} ${address.dist} ${
                  address.address
                }`,
                value: address.id,
              })
