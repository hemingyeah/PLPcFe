    ...
    <div class="info-box flex-x al-start">
      ...
      <div class="flex-x al-start mar-r-57 mar-b-20">
        ...
        <div class="flex-y code-box" v-show="setData.protalUrl">
          <div class="qrcode cur-point" ref="qrCodeUrl"></div>
          <div class="code-des">网页入口</div>
        </div>
        <div class="flex-y code-box mar-l-16 i-can-scale" v-show="setData.weChatQRCodeUrl">
          <img class="cur-point" :src="setData.weChatQRCodeUrl" alt />
