...
// 后端 web项目路径
const WEB_PATH = config.targetRootPath
// web项目静态资源路径
const WEB_RESOURCE_PATH = config.webResourcePath
...
function copyResource() {
  let targetPath = `${WEB_RESOURCE_PATH}/pc-fe-static`;
...
async function genJSP(directory) {
  ...
  let distTargetPath = `${WEB_RESOURCE_PATH}/pc-fe`
  let jspTargetPath = `${WEB_PATH}/shb-web/src/main/webapp/WEB-INF/views/dist`
